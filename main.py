...
def get_arguments():
    ...
    if not options.interface or not options.new_mac:
        parser.error("[-] Please specify both interface and new MAC address. Use --help for more info")
...
def get_current_mac(interface):
    try:
        ...
        print("[-] Error occurred while fetching MAC address:", e)
    return None
...
if current_mac:
    ...
    print("[-] Couldn't retrieve current MAC address. Exiting.")
    sys.exit(1)
